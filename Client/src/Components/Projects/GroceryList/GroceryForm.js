...
const GroceryForm = ({ currentId, setCurrentId, editMessage, setEditMessage, inputText, setInputText, todo, todos, setTodos, setStatus }) => {
    ...
    return (
        <div>
            ...
            <form>
                ...
                <input style={{ height: '2rem' }} value={inputText} onChange={setInputTextHandler} type="text" placeholder="Grocery Item?" />
