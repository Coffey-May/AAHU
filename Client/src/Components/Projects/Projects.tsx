...
let decriptions = {
   ...
   "Art": "This project is a portfolio of my many oil paintings. Visitors can explore my virtual exhibit, and view detail modals of each painting for a closer inspection. A contact page is also provided for inquiries regarding commissioning new work.",
   "Grocery": "sklfnldfnl",
...
const projectData = [
   { title: 'Multi Step Form', description: `${decriptions.Multi}`, image: `${Memphis}`, linkMultiForm: '/multi-step-form', bgColor: '#688E26' },
