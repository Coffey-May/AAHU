          ...
          <Grid item lg={6} md={6} sm={12} xs={12}>
            ...
            >
              ...
              >
                ...
                <Typography className={classes.subtitle} style={{ padding: ' 20px 0px 25px 0px', fontSize: "medium", fontWeight: 300 }} >Progressive Web Applications in React, NodeJs, and more...</Typography>
